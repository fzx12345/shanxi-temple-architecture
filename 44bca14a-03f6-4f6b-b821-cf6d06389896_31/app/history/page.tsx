...
import CulturalStories from './CulturalStories';
import DynastyInfluences from './DynastyInfluences';
import LegendaryArtisans from './LegendaryArtisans';
        ...
        <div className="max-w-7xl mx-auto px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-8">
              ...
              <Link href="/history" className="text-amber-600 font-semibold cursor-pointer">历史演变</Link>
